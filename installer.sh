...
read -p "Enter Widget Website URL [default: ${WIDGET_WEBSITE_URL:-}]: " INPUT_WIDGET_WEBSITE_URL
WIDGET_WEBSITE_URL=${INPUT_WIDGET_WEBSITE_URL:-${WIDGET_WEBSITE_URL:-}}
...
WIDGET_WEBSITE_URL="$WIDGET_WEBSITE_URL"
